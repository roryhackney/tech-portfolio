    ...
    <div class="project-card">
        ...
        <a href="php-finale.php">
            <picture class="small-image dark-image">
                <source media="(min-width: 401px)" srcset="assets/php-finale-card-medium.jpg">
    ...
    <div class="project-card">
        ...
        <a href="database-design.php">
            <picture class="small-image">
                <source media="(min-width: 401px)" srcset="assets/database-erd-diagram-card-medium.jpg">
        ...
        <a href="database-design.php.php">
...
<div class="column is-half">
    <div class="project-card">
        ...
        <a href="yamagiwa-massage.php">
            <picture class="small-image">
                <source media="(min-width: 401px)" srcset="assets/yamagiwa-massage-card-medium.jpg">
...
<div class="column is-half is-hidden-mobile">
    <div class="project-card">
        ...
        <a href="the-book-shelf.php">
            <picture class="small-image">
                <source media="(min-width: 401px)" srcset="assets/book-shelf-card-medium.jpg">
