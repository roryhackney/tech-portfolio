            ...
            <div class="main-content">
                <div class="columns is-multiline">
                    <div class="my-text-column">
                        <p class="mb-4">My recently updated resume is available as HTML, emailable PDF, printable PDF, and plain text. If you have questions or want to reach out, please use my contact form, email <a href="mailto:roryhackney@gmail.com">roryhackney@gmail.com</a>, or check out my <a href="htttps://www.linkedin.com/in/roryhackney" target="_blank" aria-label="LinkedIn - opens in new tab">LinkedIn</a>.</p>
                        <div class="columns">
                            <div class="column is-one-third">
                                <a class="button unset-width" href="assets/resume.pdf" target="_blank" aria-label="Emailable PDF - file opens in new tab">Emailable PDF<span class="icon button-external"><img src="assets/arrow-up-right-from-square-solid.svg" alt="opens in new tab"></a>
                            </div>
                            <div class="column is-one-third">
                                <a class="button unset-width" href="assets/resume-printable.pdf" target="_blank" aria-label="Print Friendly PDF - file opens in new tab">Print Friendly<span class="icon button-external"><img src="assets/arrow-up-right-from-square-solid.svg" alt="opens in new tab"></span></a>
                            </div>
                            <div class="column is-one-third">
                                <a class="button unset-width" href="assets/resume.txt" target="_blank" aria-label="Plain Text - file opens in new tab">Plain Text<span class="icon button-external"><img src="assets/arrow-up-right-from-square-solid.svg" alt="opens in new tab"></span></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="column is-full">
                    <div class="buttons-row three">
                        ...
                        <a class="button unset-width" href="mailto:roryhackney@gmail.com" target="_blank" aria-label="Email - link opens in new tab">Email<span class="icon button-external"><img src="assets/arrow-up-right-from-square-solid.svg" alt="opens in new tab"></span></a>
